...
# Trying to fix an error: Error in { : task 1 failed - "could not find function "simTweedieTest""
clusterExport(cl, c("simTweedieTest", "rtweedie", "t.test"))
